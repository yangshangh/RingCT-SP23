; ModuleID = 'probe1.42f67965f16272ec-cgu.0'
source_filename = "probe1.42f67965f16272ec-cgu.0"
...
define internal i8 @"_ZN4core3f6421_$LT$impl$u20$f64$GT$9total_cmp17h26f0371c69976893E"(ptr align 8 %self, ptr align 8 %other) unnamed_addr #0 {
start:
  ...
  %_12 = ashr i64 %_13, 63
  %_10 = lshr i64 %_12, 1
  %1 = load i64, ptr %left, align 8, !noundef !2
  %2 = xor i64 %1, %_10
  store i64 %2, ptr %left, align 8
  %_18 = load i64, ptr %right, align 8, !noundef !2
  %_17 = ashr i64 %_18, 63
  %_15 = lshr i64 %_17, 1
  %3 = load i64, ptr %right, align 8, !noundef !2
  %4 = xor i64 %3, %_15
...
bb6:                                              ; preds = %bb1, %bb5
  %5 = load i8, ptr %0, align 1, !range !3, !noundef !2
  ret i8 %5
}

; probe1::probe
; Function Attrs: nonlazybind uwtable
define void @_ZN6probe15probe17h42dfe98eeee07ec5E() unnamed_addr #1 {
start:
; call core::f64::<impl f64>::total_cmp
  %_1 = call i8 @"_ZN4core3f6421_$LT$impl$u20$f64$GT$9total_cmp17h26f0371c69976893E"(ptr align 8 @alloc_f93507f8ba4b5780b14b2c2584609be0, ptr align 8 @alloc_ef0a1f828f3393ef691f2705e817091c), !range !3
  ret void
}
